...
export interface FirestoreFunctions {
    ...
    getDocByIdRT(col: string, id: string, callBack: Function): Promise<Unsubscribe | IResponse>;
    getDocsByParamRT(col: string, field: string, condition: WhereFilterOp, param: string, callBack: Function): Promise<Unsubscribe | IResponse>;
